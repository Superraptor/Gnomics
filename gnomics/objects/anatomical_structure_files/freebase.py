...
# Return Freebase ID.
def get_freebase_id(anat):
    fr_array = []
    for ident in anat.identifiers:
        if ident["identifier_type"].lower() == "freebase id" or ident["identifier_type"].lower() == "freebase identifier" or ident["identifier_type"].lower() == "freebase":
