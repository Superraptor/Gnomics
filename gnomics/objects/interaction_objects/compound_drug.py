...
def get_drugs(compound):
    ...
    for ident in compound.identifiers:
        if ident["identifier_type"].lower() in ["unii", "fda unique ingredient identifier code", "unique ingredient identifier"]:
        ...
        elif ident["identifier_type"].lower() in ["chebi", "chebi id", "chebi identifier"]:
