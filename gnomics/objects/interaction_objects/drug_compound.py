...
def get_compounds(drug, user = None):
    ...
    for ident in drug.identifiers:
        if (ident["identifier_type"].lower() == "drugbank accession" or ident["identifier_type"].lower() == "drugbank" or ident["identifier_type"].lower() == "drugbank id" or ident["identifier_type"].lower() == "drugbank identifier") and user is not None:
...
def drug_compound_unit_tests(drugbank_id, openphacts_app_id, openphacts_app_key):
    ...
    for com in get_compounds(drugbank_drug, user = user):
