    ...
    if pmid is not None:
        ...
        for iden in decoded["denotations"]:
            ...
            if "Species" in iden_str[0]:
                ...
                new_spec = gnomics.objects.taxon.Taxon(identifier = ncbi_species, identifier_type = "NCBI TaxID", language = None, source = "PubTator")
                ...
                new_var = gnomics.objects.variation.Variation(identifier = rs_num, identifier_type = "RS Number", language = None, source = "PubTator")
            else:
        ...
        for ident in pubmed_ref.identifiers:
            if ident["identifier_type"].lower() in ["pmid", "pubmed identifier", "pubmed id", "pubmed"]:
