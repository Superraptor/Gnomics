        ...
        clinical_trial.clinical_trial_objects.append(
            {
                ...
                'object_type': "ClinicalTrials.gov Object"
            }
        )
...
def get_nct_id(clinical_trial):
    nct_array = []
    for ident in clinical_trial.identifiers:
        if ident["identifier_type"].lower() == "nct" or ident["identifier_type"].lower() == "nct id" or ident["identifier_type"].lower() == "nct identifier":
            nct_array.append(ident["identifier"])
    return nct_array
